...
<div class="section bg-gray at-a-glance">
    <div class="content group-header">
        ...
        <p>Scores range from 0-100% comparing {{ $type === 'sheriff' ? 'counties' : ($type === 'state' ? 'states' : 'cities') }} with {{ $scorecard['police_funding']['comparison_group'] }} population. {{ $type === 'sheriff' ? 'Counties' : ($type === 'state' ? 'States' : 'Cities') }} with higher scores spend less on policing, use less force, are more likely to hold officers accountable and make fewer arrests for low-level offenses.</p>
    </div>
