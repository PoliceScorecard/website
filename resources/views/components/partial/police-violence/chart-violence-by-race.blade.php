<div class="stat-wrapper grouped">
    ...
    <p class="source-link-wrapper">
        ...
        <a href="https://mappingpoliceviolence.us" class="source-link" rel="noopener" target="_blank" {!! trackData('External Nav', 'Violence by Race', 'Mapping Police Violence') !!}>Mapping Police Violence</a>,
