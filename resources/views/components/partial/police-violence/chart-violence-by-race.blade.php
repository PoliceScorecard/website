<div class="stat-wrapper grouped">
    ...
    <p class="source-link-wrapper">
        ...
        <a href="http://policeviolencereport.org" class="source-link" rel="noopener" target="_blank" {!! trackData('External Nav', 'Violence by Race', 'Police Violence Report') !!}>Police Violence Report</a>,
