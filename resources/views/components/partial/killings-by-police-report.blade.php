  ...
  <div class="content">
    <div class="one-third">
      ...
      <div class="text">
        ...
        <p>That's a higher rate than <strong>{{ num($scorecard['report']['percentile_killed_by_police'], 0, '%', true) }}</strong> of US {{ ($type === 'police-department') ? 'Police' : 'Sheriff' }} Departments.</p>
        @else
