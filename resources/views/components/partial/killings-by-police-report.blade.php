  ...
  <div class="content">
    <div class="one-third">
      ...
      <div class="text">
        ...
        <p>This agency did not reportedly kill anyone from 2013-25.</p>
        @elseif(intval($scorecard['report']['total_people_killed']) === 1)
        <p>{{ $scorecard['agency']['name'] }} {{ ($type === 'police-department') ? 'Police' : 'Sheriff' }} Department killed 1 person from 2013-25.</p>
        ...
        <p>{{ $scorecard['report']['total_people_killed'] }} people killed by {{ $scorecard['agency']['name'] }} {{ ($type === 'police-department') ? 'Police' : 'Sheriff' }} Department from 2013-25</p>
    ...
    <div class="one-third">
      ...
      <div class="text">
        <p><strong>{{ num($scorecard['report']['percent_misdemeanor_arrests'], 0, '%') }}</strong> of all arrests were for low-level, non-violent offenses from 2013-25.</p>
      </div>
