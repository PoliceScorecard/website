...
1/2 ( Percent Discrimination, Excessive Force and Criminal Complaints Sustained )</pre>
            ...
            <p>
            The approach to policing score evaluates the extent to which police departments focus on arresting people for low-level offenses or focusing on solving serious crimes. The score accounts for the proportion of the most serious crimes - homicide - that an agency solves as well as how each agency compares in terms of its approach to the lowest level offenses. We defined low level offenses as the combination of all arrests for drug offenses, public drunkenness and other alcohol-related offenses; vagrancy, loitering, gambling, disorderly conduct, prostitution, vandalism, and other minor non-violent offenses. These types of offenses are usually classified as misdemeanors and are often associated with issues of substance abuse, homelessness and sex work. This definition excludes all arrests for violent crimes, assaults, crimes against families and children, weapons offenses, sex offenses and all arrests for property crimes except for vandalism.[1] Higher rates of low level arrests per population suggest a department is engaging in aggressive "public order" or "broken-windows" policing practices that have not been proven to improve public safety and instead expose communities, especially marginalized communities, to increased policing, arrest and incarceration (for additional reading, see <a href="https://www.researchgate.net/publication/263234452_Studying_New_York_City%27s_Crime_Decline_Methodological_Issues&sa%3DD&ust%3D1553928833130000" target="_blank" rel="noopener" {!! trackData('External Nav', 'About', 'Research Gate') !!}>here</a>, <a href="https://www.washingtonpost.com/outlook/2019/12/27/how-year-old-study-was-misconstrued-create-destructive-broken-windows-policing/" target="_blank" rel="noopener" {!! trackData('External Nav', 'About', 'Washington Post') !!}>here</a> and <a href="https://fivethirtyeight.com/features/police-arresting-fewer-people-for-minor-offenses-can-help-reduce-police-shootings/amp/" target="_blank" rel="noopener" {!! trackData('External Nav', 'About', 'Five Thirty Eight') !!}>here</a>). Racial disparities in drug arrests were also factored into a department's approach to policing score. Since there are <a href="https://www.hamiltonproject.org/charts/rates_of_drug_use_and_sales_by_race_rates_of_drug_related_criminal_justice" target="_blank" rel="noopener" {!! trackData('External Nav', 'About', 'Hamilton Project') !!}>similar rates of drug use and drug sales</a> among most racial and ethnic groups, disparities in which groups police arrest for drug offenses suggest a biased approach to law enforcement. As such, we used data on racial disparities in drug arrests as a proxy for estimating racial bias. We calculated racial disparities both between Black and white populations and between Latinx and white populations, converting the most extreme of these two disparities to a percentile score for racial disparities in law enforcement.
            </p>
...
<pre>(
    ...
    Percentile Jail Deaths per Jail Population
            ...
            <p>
                We used the reported number of arrests of Non-Hispanic Black people, Non-Hispanic white people, and Hispanic people (of all races) to calculate Black-white and Latinx-white arrest disparities relative to the 2020 Census population in each jurisdiction with available data. Unlike the earlier Uniform Crime Reporting system, the FBI National Incident-Based Reporting System provides detailed breakdowns of arrests by race and ethnicity, specifying the number of arrestees who were perceived to be Hispanic Black, Non-Hispanic Black, Hispanic white, Non-Hispanic white, etc. Additional data obtained from California, New York City, and Chicago, which report arrests to their own reporting systems, also include breakdowns of arrests by race and ethnicity. Altogether, we obtained arrest data permitting disaggregation by race and ethnicity from 6,235 jurisdictions in the Police Scorecard covering 68% of the nation's population and 73% of the nation's Hispanic population.
            </p>
            ...
            <p>
                For some agencies, these computations resulted in negative values for Non-Hispanic Black Arrests or Non-Hispanic White Arrests, in which case we reallocated the number of Black-Hispanic Arrests or White-Hispanic Arrests to the other race category so that the negative arrests would equal 0.
            </p>
            ...
            <p>
                <a href="{{ asset('/images/about-hispanic-jurisdictions.png') }}" target="_blank" rel="noopener" class="image-link" title="Open Image" style="max-width: 320px;">
                    <img src="{{ asset('/images/about-hispanic-jurisdictions.png') }}" alt="Jurisdictions with 15% or More Hispanic Population that Failed to Report Hispanic Arrests" />
                </a>
            </p>
